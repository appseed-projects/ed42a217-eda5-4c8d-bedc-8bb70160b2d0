...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-04 06:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ed42a217-eda5-4c8d-bedc-8bb70160b2d0.git
$ cd ed42a217-eda5-4c8d-bedc-8bb70160b2d0
```
